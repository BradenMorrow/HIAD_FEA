function [FEM,theta] = build_tor(C,tor,straps,load,min_nodes)
...
% min_nodes = 800; % Minimum number of torus nodes
...
theta0_1 = vertcat(theta0.theta1);
theta0_1 = theta0_1(:);
theta0_2 = vertcat(theta0.theta2);
theta0_2 = theta0_2(:);
...
for i = 1:size(C,1)
    ...
    % % %  point loads
    F = zeros(size(bound)); % press_dist(load(i,:),theta,C(i,1)); % Linear symetrical pressure distribution
