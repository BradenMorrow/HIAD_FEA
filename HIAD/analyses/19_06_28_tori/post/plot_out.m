...
Uzm(1) = [];
Rz(1) = [];
plot(Uzm*Ufac - Uzm(1)*Ufac,Rz*Ffac,'b-','linewidth',1,'markersize',10)
...
leg(2) = plot([1 1]*-1000,[1 1]*-1000,'b-','linewidth',1,'markersize',10);

legend(leg,'Test','Model, Pressure equilibrium step prestressing method','location','northwest')
