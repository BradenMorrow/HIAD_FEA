...
% Solver and analysis
ANALYSIS.d_inc = 1000; % Starting number of loading increments
...
ANALYSIS.max_inc = 100; % Maximum number of increments
ANALYSIS.min_inc_size = 1e-10; %Minimum increment size to abort program

ANALYSIS.max_iter = 100; % Maximum number of iterations per increment
