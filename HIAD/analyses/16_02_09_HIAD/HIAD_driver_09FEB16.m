...
FEM_out.PLOT.scale = 1;
FEM_out.PLOT.els = [0 0 1]';
FE_plot(FEM_out)

% post_proc_driver2

% save('out_02MAR16_full2','FEM_out')
...
% Symmetry boundaries
% Vectorization of follow force routines
% Further parallelize the assembly function
% Post processing results
% Stiffness of interaction elements after separation
