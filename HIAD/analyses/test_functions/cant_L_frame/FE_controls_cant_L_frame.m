function [ANALYSIS] = FE_controls_cant_L_frame
% Analysis controls for FE analysis

% Solver and analysis
ANALYSIS.d_inc = 100; % Starting number of loading increments
ANALYSIS.control = 3; % 1 - Displacement control solver;
...
ANALYSIS.res_error_info = false; % residual error infoANALYSIS.warning = true; % Display warnings
