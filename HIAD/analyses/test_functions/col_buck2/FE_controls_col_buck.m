function [ANALYSIS] = FE_controls_col_buck
% Analysis controls for FE analysis

% Solver and analysis
ANALYSIS.d_inc = 200; % Starting number of loading increments
