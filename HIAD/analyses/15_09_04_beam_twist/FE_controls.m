...
ANALYSIS.tol = 1e-3; % Solver tolerance, (normalized to force vector)
ANALYSIS.Dmax = 5; % Absolute maximum displacement
...
ANALYSIS.follow_F2 = 'F2_tor_TIM'; % Used in arc length solver
