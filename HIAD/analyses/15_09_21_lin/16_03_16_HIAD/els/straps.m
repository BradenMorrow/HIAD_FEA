...
% [loop_f,loop_k] = strap_response(114000,300,50,2);
% [rad_f,rad_k] = strap_response(114000,300,100,2);
% [chev_f,chev_k] = strap_response(114000,114000,10,1);
...
for i = 1:size(connect,1)
    ...
    EL(i).el = 'el4'; % @el4; % Corotational beam with axial lookup table
