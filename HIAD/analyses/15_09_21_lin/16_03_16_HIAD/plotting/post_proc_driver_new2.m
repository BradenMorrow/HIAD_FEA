function post_proc_driver_new2(FEM)
...
plot_tor(1).LS = 18; % load step plotted
...
plot_tor(1).auto_scale = 0; % auto color scale switch 
plot_tor(1).caxis = [0 35.433]; % Min and max displacement scale
...
plot_tor(2).tor_num = tor_num; % Number of tori present
...
plot_tor(3).tor_num = tor_num; % Number of tori present
...
plot_tor(4).tor_num = tor_num; % Number of tori present
...
plot_tor(5).tor_num = tor_num; % Number of tori present
...
FEM.PLOT.els = [0 1 1 0]';
FEM.PLOT.fig = 2;
FEM.PLOT.undef = false;
FEM.PLOT.def = true;
