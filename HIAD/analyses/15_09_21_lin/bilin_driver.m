...
%% Elements
E = 10e6;
A1 = .002/10; % Compression
A2 = .002/10000; % Tension
I = 1.666667e-8;
...
for i = 1:n - 1
    ...
    EL(i).el = @el1; % Linear beam, bilinear compression
...
%     EL(i).el_in0.geom.geom1 = [A1 I I 0 2*I]; % [A Izz Iyy ky J]
%     EL(i).el_in0.geom.geom2 = [A2 I I 0 2*I]; % [A Izz Iyy ky J]
%     EL(i).el_in0.geom.eps0 = 0; % [A Izz Iyy ky J]
      EL(i).el_in0.geom = [A1 I I 0 2*I];
...
FEM.ANALYSIS = FE_controls_bilin;
