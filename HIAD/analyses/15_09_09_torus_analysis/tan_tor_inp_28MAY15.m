...
%% Connectivities
% strap_ind = J(n + 1:end);
tan_tor_ind = (strap_ind(end) + 1:strap_ind(end) + size(tan_tor_nodes,1))';
...
tan_tor_F2 = zeros(size(tan_tor_bound,1),size(P_strap,3));
...
config = 3*ones(size(tan_tor_connect,1),1);
