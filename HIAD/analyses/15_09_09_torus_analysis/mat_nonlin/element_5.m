function [Kel,Fint_i,fint_i,y_bar,cord,f_shell,EI,rot,DELTA_rot,DEBUG] = element_5(element_in)
%ELEMENT_5
...
[KL,P,y_bar,f_cord,EI,eps_cord,f_shell,DEBUG] = get_KL_P_CL(element_in);
% ax = zeros(size(eps_cord));
% ax(1:2,1) = f0;
% ax(1,2) = eps_new;
cord = [eps_cord f_cord];
