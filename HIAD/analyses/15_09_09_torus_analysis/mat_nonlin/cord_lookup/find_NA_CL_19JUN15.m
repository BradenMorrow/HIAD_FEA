...
%     delta_eps_cord = eps_cord - eps_cord_old;
    ...
    f_cord = delta_f_cord + f_cord_old;
...
%     f_plus = sum(f_cord_plus)' + 2*pi*r*t*EL*y_bar_plus.*kappa2 + EL*A*eps;
    f_plus = sum(delta_f_cord_plus)' - sum(k_cord*delta_eps)' + 2*pi*r*t*EL*y_bar_plus.*kappa2; % - f_shell_old;
