...
% % % % strap_test_SI(fig_1)
% % % strap_forces_SI_pub(FEM_out,straps,strap_type,strap_EL_1,fig_1)
...
leg(1) = plot([-100 -100],[-100 -100],'k-');
leg(2) = plot([-100 -100],[-100 -100],'k--');
leg(3) = plot([-100 -100],[-100 -100],'r-');
leg(4) = plot([-100 -100],[-100 -100],'r--');

legend(leg,'Fore cord, measured','Fore cord, predicted','Aft cord, measured','Aft cord, predicted')
