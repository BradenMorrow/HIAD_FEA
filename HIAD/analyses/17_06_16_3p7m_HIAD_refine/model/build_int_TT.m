function [FEM] = build_int_TT(FEM,theta,C,tor,pre_str,Ccon)
...
for i = 1:size(Ccon,1)
    ...
    if (i == 1)
        ...
        K_ax1 = tor(Ccon(i,1) - 1).K_ax*2; % lbf/in/in
        K_ax2 = tor(Ccon(i,2) - 1).K_ax*2; % lbf/in/in
        ...
        K_shear1 = tor(Ccon(i,1) - 1).K_shear*8; % Stiffness (of half of member) lbf/in/in
        K_shear2 = tor(Ccon(i,2) - 1).K_shear*8; % Stiffness (of half of member) lbf/in/in
