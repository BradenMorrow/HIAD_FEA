function [straps] = define_straps_28JUN17(C,r,alpha_cone)
...
% % % PT = 50;
% % % [axial_2in_loop,axial_k_2in_loop] = strap_PT(cord_response_2in_loop,PT);
% % % [axial_2in_chev,axial_k_2in_chev] = strap_PT(cord_response_2in_chev,PT);
% % % [axial_1p75in,axial_k_1p75in] = strap_PT(cord_response_1p75in,PT*2);
...
PT = 50;
[axial_2in_loop,axial_k_2in_loop] = strap_PT(cord_response_2in_loop,PT);
straps(S).PT = PT; % Level of strap pretension
...
straps(S).side = 1; % Side of HIAD strap is on (0 - fore, 1 - aft)
PT = 40;
[axial_1p75in,axial_k_1p75in] = strap_PT(cord_response_1p75in,PT);
straps(S).PT = PT*2; % Level of strap pretension
