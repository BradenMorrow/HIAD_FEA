function [straps] = define_straps_22JUN17(C,r,alpha_cone)
...
[axial_2in,axial_k_2in] = strap_PT(cord_response_2in,20);
[axial_1p75in,axial_k_1p75in] = strap_PT(cord_response_1p75in,40);
...
straps(S).axial = axial_2in; % Strap response piecewise polynomial
straps(S).axial_k = axial_k_2in; % Strap stiffness piecewise polynomial
