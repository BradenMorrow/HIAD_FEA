...
el_int = 15; % 21; % Number of elements between cable nodes
...
GLH_i = 2379*1; % In-plane shear modulus (lb/in)
...
tor.GLH = GLH_i; % 2670; % In-plane shear modulus (lb/in)
...
%     %%
    ...
    FE_plot(FEM_out00)
    plot_tor_shape_an_only(FEM_out00)
