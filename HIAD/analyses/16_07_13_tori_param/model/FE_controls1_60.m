function [ANALYSIS] = FE_controls1_60
% Analysis controls for FE analysis

% Solver and analysis
ANALYSIS.d_inc = 100; % 1; % 10000; % Starting number of loading increments
...
ANALYSIS.min_inc_size = 1e-10; % .001; % Minimum increment size before aborting
...
ANALYSIS.Dmax = 2; % Absolute maximum displacement
