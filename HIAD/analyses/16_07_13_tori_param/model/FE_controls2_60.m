function [ANALYSIS] = FE_controls2_60
...
ANALYSIS.max_iter = 50; % Maximum number of iterations per increment
...
ANALYSIS.step = 3; % Initialize load step counter

% Automatic load stepping
ANALYSIS.adapt = true;
ANALYSIS.inc_target = 10; % 4; % 
ANALYSIS.inc_power = .5;
ANALYSIS.max_inc = .05; % .1; % 1; % 
