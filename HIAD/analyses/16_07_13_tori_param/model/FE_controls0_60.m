function [ANALYSIS] = FE_controls0_60
% Analysis controls for FE analysis

% Solver and analysis
ANALYSIS.d_inc = 1; % 400; % 100; % Starting number of loading increments
...
ANALYSIS.max_inc_count = 40; % Maximum number of increments
