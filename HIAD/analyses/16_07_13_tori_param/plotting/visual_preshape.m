function visual_preshape(FEM)

% Run using old method?
run_old = 0;
...
plot_tor(1).LS = 1; % load step plotted
...
plot_tor(1).tor_num = 1; % Number of tori present

%% Deformed with Fill
plot_tor(2).n = 0; % Number of slats on cross section, 0 for no plot
plot_tor(2).LS = 1; % load step plotted
...
plot_tor(2).frac = 1; % 1/frac is fraction of data used
plot_tor(2).tor_num = 1; % Number of tori present

%% Undeformed with Fill
plot_tor(3).n = 30; % Number of slats on cross section, 0 for no plot
...
plot_tor(3).fig = 7; %figure number
...
plot_tor(3).tor_num = 1; % Number of tori present

%% Deformed Wireframe
plot_tor(4).n = 15; % Number of slats on cross section, 0 for no plot
plot_tor(4).LS = 1; % load step plotted
plot_tor(4).PF = 0; % plot forces?
plot_tor(4).plot_type = 4; % 1 = DCP, 2 = DF, 3 = UF, 4 = DWF, 5 = UWF 
plot_tor(4).def= 1;
plot_tor(4).fig = 7; %figure number
...
plot_tor(4).tor_num = 1; % Number of tori present
...
plot_tor(5).tor_num = 1; % Number of tori present
