function visual_postshape(FEM)

% Plot using old method?
run_old = 0;

%% Color Plot
plot_tor(1).n = 10; % Number of slats on cross section, 0 for no plot, 
...
plot_tor(1).triad_loc = [0 0 9]'; % triad location
