...
dir_working = '\\storage-01.umcomposites.umaine.edu\Projects\1115 NASA HypersonicInflatableDevices\Experimental\Single Torus Testing\Buckling Test Results\Data\2016-03-16\2016-03-16_01.31.14_T4AP-1_Torsion_20psi_1';
mat_file_ID = 1207;
csv_file_ID = '2016-03-16_01.31.14_T4AP-1_Torsion_20psi_1_Mat.txt';
...
%Arranging theta so they go from 0-2pi
theta(theta < 0) = theta(theta < 0) + 2*pi;
% Sorting theta in ascending order and getting indices.
[theta,ind]=sort(theta);

%Assigning radius to corresponding theta values.
for i = 1:size(R,2)
 R1=R(:,i);
 ind1=ind(:,i);
 R1=R1(ind1);
...
%Assigning x,y,z to corresponding theta values.
