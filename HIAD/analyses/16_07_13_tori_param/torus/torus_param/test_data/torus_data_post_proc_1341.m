...
dir_working = '\\storage-01.umcomposites.umaine.edu\Projects\1115 NASA HypersonicInflatableDevices\Torus Data\2016-04-07\2016-04-07_05.53.15_T3AP-3_Buckling_10psi_1';
mat_file_ID = 1341;
csv_file_ID = '2016-04-07_05.53.15_T3AP-3_Buckling_10psi_1_Mat.txt';
...
% Assigning R to corresponding theta values.
for i = 1:size(R,2)
 R1=R(:,i);
 ind1=ind(:,i);
 R1=R1(ind1);
