...
dir_working = '\\storage-01.umcomposites.umaine.edu\Projects\1115 NASA HypersonicInflatableDevices\Torus Data\2016-04-07\2016-04-07_03.46.05_T3AP-3_Buckling_5psi_1';
mat_file_ID = 1336;
csv_file_ID = '2016-04-07_03.46.05_T3AP-3_Buckling_5psi_1_Mat.txt';
...
%Calculate Radius and theta for points of interest
...
%Arrange theta so they vary from 0 - 2pi
theta(theta < 0) = theta(theta < 0) + 2*pi;
%Sort theta in ascending order and record indices.
[theta,ind]=sort(theta);

%Assign radius to corresponding theta values.
for i = 1:size(R,2)
 R1=R(:,i);
 ind1=ind(:,i);
 R1=R1(ind1);
 ...
 %Assign x,y,z coordinates to corresponding theta values.
