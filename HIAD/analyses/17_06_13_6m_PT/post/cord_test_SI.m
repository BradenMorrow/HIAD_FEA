...
figure(fig_1)
hold on
plot(-ram(ind)*Ffac_kN,CS_F_T2(ind,:)*1e6,'k-')
xlim([0 40])
% ylim([0 500])
...
figure(fig_1)
hold on
plot(-ram(ind)*Ffac_kN,CS_A_T2(ind,:)*1e6,'r-')
xlim([0 40])
% ylim([0 2.5])
...
figure(fig_1 + 1)
hold on
plot(-ram(ind)*Ffac_kN,CS_F_T7(ind,:)*1e6,'k-')
xlim([0 40])
% ylim([0 500])
...
figure(fig_1 + 1)
hold on
plot(-ram(ind)*Ffac_kN,CS_A_T7(ind,:)*1e6,'r-')
xlim([0 40])
% ylim([0 2.5])
