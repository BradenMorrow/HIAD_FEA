function post_proc_driver2(FEM)
...
plot_tor(1).frac = 3; % 1/frac is fraction of data used
plot_tor(1).tor_num = 9; % Number of tori present
...
plot_tor(4).def = 0;
plot_tor(4).fig = 5; %figure number
...
plot_tor(4).tor_num = 8; % Number of tori present
