...
% % % % % % plot((Uvert0(ind) - Uvert0(ind(1)))*Ufac,-ram(ind)*Ffac,'k--','linewidth',2)
% % % % % % plot((Uvert90(ind) - Uvert90(ind(1)))*Ufac,-ram(ind)*Ffac,'k--','linewidth',2)
% % % % % % plot((Uvert270(ind) - Uvert270(ind(1)))*Ufac,-ram(ind)*Ffac,'k--','linewidth',2)
% % % plot(Utest*Ufac,-ram(ind)*Ffac,'k-','linewidth',2)

% Modeling
% plot(Uzp,Rz,'bo-')
plot(Uzm*Ufac,Rz*Ffac,'k.-','linewidth',1,'markersize',10)

xlabel('Vertical displacement of T7 (in)')
ylabel('Ram load (lbf)')

% % % leg(1) = plot([1 1]*-1000,[1 1]*-1000,'k-','linewidth',2);
% % % leg(2) = plot([1 1]*-1000,[1 1]*-1000,'k.-','linewidth',1,'markersize',10);
% % % 
