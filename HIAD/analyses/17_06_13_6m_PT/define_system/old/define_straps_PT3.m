function [straps] = define_straps_PT3(C,r,alpha_cone)
...
alpha = 90 - alpha_cone;
num_straps = 28; % 12; % Divisible by 4
...
% [axial,axial_k] = strap_response_22SEP16(k_ten*2,k_com*2,straps(S).PT,F0,eps0/2);
[axial,axial_k] = strap_response_22SEP16(k_ten/2,k_com/2,straps(S).PT,F0,eps0*2);
if ~PT_analysis
