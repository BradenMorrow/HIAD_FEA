...
% [straps(S).axial,straps(S).axial_k,straps(S).mat,straps(S).geom,straps(S).eps0] = loop_config_21FEB17(straps(S).PT,1);
...
[straps(S).axial,straps(S).axial_k,straps(S).mat,straps(S).geom,straps(S).eps0] = chev_config_21FEB17(straps(S).PT,1);
