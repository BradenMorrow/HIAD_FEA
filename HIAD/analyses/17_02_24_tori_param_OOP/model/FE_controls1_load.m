function [ANALYSIS] = FE_controls1_load
% Analysis controls for FE analysis

% Solver and analysis
ANALYSIS.d_inc = 10000000; % 10000; % Starting number of loading increments
...
ANALYSIS.adapt = true;
ANALYSIS.inc_target = 30; % 20; % 
ANALYSIS.inc_power = 1; % .5
ANALYSIS.max_inc = .025; % .4; % .1; % 1; % 
