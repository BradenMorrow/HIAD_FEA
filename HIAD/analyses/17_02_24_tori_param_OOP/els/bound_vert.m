...
k1 = [7000
    ...
    4000
    5500
    7000]; % Compression stiffness (lb/in) % 1e10; % 
...
PP(8).cable_k = [];
for i = 1:8
    [PP(i).cable_f,PP(i).cable_k] = lin_strap_response(k0,k1(i),.0001);
end
...
%     EL(i).el = @el1_nonlin; % Linear, corotational beam
    ...
    % Axial response
    EL(i).el_in0.axial = PP(i).cable_f;
    EL(i).el_in0.axial_k = PP(i).cable_k;
end
