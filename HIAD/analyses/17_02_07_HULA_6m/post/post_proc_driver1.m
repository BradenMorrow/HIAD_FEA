...
plot_tor(1).tor_num = 7; % Number of tori present
...
plot_tor(2).tor_num = 7; % Number of tori present
...
plot_tor(3).tor_num = 7; % Number of tori present
...
plot_tor(4).tor_num = 7; % Number of tori present
...
plot_tor(5).tor_num = 7; % Number of tori present
