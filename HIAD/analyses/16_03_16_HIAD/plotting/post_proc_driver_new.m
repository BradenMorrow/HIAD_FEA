function post_proc_driver_new(FEM)
...
plot_tor(3).n = 12; % Number of slats on cross section, 0 for no plot
...
plot_tor(5).n = 15; % Number of slats on cross section, 0 for no plot
