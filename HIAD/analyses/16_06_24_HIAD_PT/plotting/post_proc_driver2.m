...
%% Deformed with Fill
plot_tor(2).n = 10; % Number of slats on cross section, 0 for no plot
plot_tor(2).LS = size(FEM.OUT.Uinc,2); % load step plotted
...
plot_tor(3).n = 10; % Number of slats on cross section, 0 for no plot
...
plot_tor(3).frac = 4; % 1/frac is fraction of data used
plot_tor(3).tor_num = 6; % Number of tori present
...
plot_tor(4).frac = 4; % 1/frac is fraction of data used
...
plot_tor(5).frac = 4; % 1/frac is fraction of data used
plot_tor(5).tor_num = 6; % Number of tori present
