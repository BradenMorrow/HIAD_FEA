function [MODEL,EL,str] = links(theta,I_theta,C,r,cone_ang)
...
c_link = [(C(1,1) - r(1)*cosd(cone_ang_comp) - r(1)*sind(cone_ang_comp)), (C(1,2) - r(1)*sind(cone_ang_comp) + r(1)*cosd(cone_ang_comp)) % Centerbody tieback - AFT
    (C(1,1) - r(1)*sind(cone_ang_comp)), (C(1,2) + r(1)*cosd(cone_ang_comp)) % T1 - AFT
    (C(2,1) - r(2)*sind(cone_ang_comp)), (C(2,2) + r(2)*cosd(cone_ang_comp)) % T2 - AFT
    ((C(2,1) + C(3,1))/2 - r(2)*sind(cone_ang_comp)), ((C(2,2) + C(3,2))/2 + r(2)*cosd(cone_ang_comp)) % T2/T3 chevron break - AFT
    (C(3,1) - r(3)*sind(cone_ang_comp)), (C(3,2) + r(3)*cosd(cone_ang_comp)) % T3 - AFT
    (C(4,1) - r(4)*sind(cone_ang_comp)), (C(4,2) + r(4)*cosd(cone_ang_comp)) % T4 - AFT
    (C(5,1) - r(5)*sind(cone_ang_comp)), (C(5,2) + r(5)*cosd(cone_ang_comp)) % T5_1 (T4 tie) - AFT
    (C(5,1) + r(5)*sind(alpha2)), (C(5,2) + r(5)*cosd(alpha2)) % T5_2 (T6 tie) - AFT
    (C(6,1) + r(6)*sind(alpha2)), (C(6,2) + r(6)*cosd(alpha2))% T6 - AFT
    (C(1,1) - r(1)*cosd(cone_ang_comp) + r(1)*sind(cone_ang_comp)), (C(1,2) - r(1)*sind(cone_ang_comp) - r(1)*cosd(cone_ang_comp)) % Centerbody tieback - FORE
    (C(1,1) + r(1)*sind(cone_ang_comp)), (C(1,2) - r(1)*cosd(cone_ang_comp)) % T1 - FORE
    (C(2,1) + r(2)*sind(cone_ang_comp)), (C(2,2) - r(2)*cosd(cone_ang_comp)) % T2 - FORE
    ((C(2,1) + C(3,1))/2 + r(2)*sind(cone_ang_comp)), ((C(2,2) + C(3,2))/2 - r(2)*cosd(cone_ang_comp)) % T2/T3 chevron break - FORE
    (C(3,1) + r(3)*sind(cone_ang_comp)), (C(3,2) - r(3)*cosd(cone_ang_comp)) % T3 - FORE
    (C(4,1) + r(4)*sind(cone_ang_comp)), (C(4,2) - r(4)*cosd(cone_ang_comp)) % T4 - FORE
    (C(5,1) + r(5)*sind(cone_ang_comp)), (C(5,2) - r(5)*cosd(cone_ang_comp)) % T5 - FORE
    (C(6,1) + r(6)*sind(cone_ang_comp)), (C(6,2) - r(6)*cosd(cone_ang_comp))]; % T6 - FORE
...
orientation(:,3) = r(1)*cosd(cone_ang_comp);
