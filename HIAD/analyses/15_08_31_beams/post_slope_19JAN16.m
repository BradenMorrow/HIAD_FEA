...
load('C:\Users\andrew.young\Desktop\FE_code\Eeff_13JAN16\analysis\15_08_31_beams\results_13JAN16\output_13JAN16_Eeff.mat')
FEM_out = out(48);
ind1 = 33;

% Load and displacement
u = [0; -FEM_out.FEM_out.OUT.Uinc(end - 4,:)'];
f = [0; FEM_out.FEM_out.OUT.Finc(6 - 4,:)'*2];
...
cd 'C:\Users\andrew.young\Desktop\FE_code\Eeff_13JAN16'
...
%%
% [beam test shell]
k60_1 = [4.45647	5.13799 5.8426		% 60	deg,	5	psi,	1	up	17
    6.23572	7.1651  8.0926              % 60	deg,	10	psi,	1	up	19
    7.594	8.96211 9.8851              % 60	deg,	15	psi,	1	up	21
    9.852	10.7336 11.595];            % 60	deg,	20	psi,	1	up	23
    
k60_2 = [8.82534	10.5987 10.819      % 60	deg,	5	psi,	2	up	18
    12.3311	14.8576 15.11               % 60	deg,	10	psi,	2	up	20
    15.4716	18.758  17.899              % 60	deg,	15	psi,	2	up	22
    19.3814	21.9168 21.98];             % 60	deg,	20	psi,	2	up	24
    
k71_1 = [3.96076	4.29975 6.6651      % 71	deg,	5	psi,	1	up	41
    4.84559	6.00842 7.3684              % 71	deg,	10	psi,	1	up	43
    4.3175	6.82961 7.1798              % 71	deg,	15	psi,	1	up	45
    4.45719	7.4426  7.4132];            % 71	deg,	20	psi,	1	up	47

k71_2 = [8.67278	4.67229 11.302		% 71	deg,	5	psi,	2	up	42
    9.90007	9.13573 13.816              % 71	deg,	10	psi,	2	up	44
    8.9655	11.7344 12.773              % 71	deg,	15	psi,	2	up	46
    10.1948	17.4533 14.416];            % 71	deg,	20	psi,	2	up	48
