function [PLOT] = plot_controls_deformed
% Plotting controls for FE analysis

% Plotting flags for FE_plot
PLOT.plot = 1; % 1 = plot output
PLOT.fig = 2; % Figure number
PLOT.scale = 1e5; % Deformation scale
PLOT.undef = 0; % Plot undeformed shape
PLOT.def = 1; % Plot deformed shape
PLOT.force = 0; % Plot forces
PLOT.number = 0; % Plot node numbers
PLOT.triad = 0; % Plot triad
PLOT.els = [1 1 1 1 1]'; % Element types to plot [1 2 3 4];
PLOT.view = 2;
