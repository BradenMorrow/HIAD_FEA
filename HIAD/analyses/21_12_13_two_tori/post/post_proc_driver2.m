...
plot_tor(2).def= 1;
plot_tor(2).fig = 7; %figure number
...
plot_tor(3).fig = 8; %figure number
...
plot_tor(4).u_comp = 0; % U_component = 1 for x, 2 for y, 3 for z, 4 for magnitude
...
plot_tor(5).def = 0;
plot_tor(5).fig = 10; % figure number
