function [ANALYSIS] = FE_controls0_opt
% Analysis controls for FE analysis

% Solver and analysis
ANALYSIS.d_inc = 1; % 1000; % Starting number of loading increments
...
ANALYSIS.max_inc_count = 1; % 500; % Maximum number of increments
ANALYSIS.min_inc_size = .75; % 1e-10; % Minimum increment size to abort program

ANALYSIS.max_iter = 1; % 15; % Maximum number of iterations per increment
