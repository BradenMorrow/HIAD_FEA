...
plot_tor(3).n = 0; % Number of slats on cross section, 0 for o plot
plot_tor(3).LS = 36; % load step plotted
...
plot_tor(3).color = 'k'; % color  of fill or wireframe
...
plot_tor(5).LS = 36; % load step plotted
...
plot_tor(5).color = 'k'; % color  of fill or wireframe
plot_tor(5).view = 6; % TF = 1 for Bottom View, 
    % TF = 2 for Top View
    % TF = 3 for Right View
    % TF = 4 for Left View
    % TF = 5 for Back View
