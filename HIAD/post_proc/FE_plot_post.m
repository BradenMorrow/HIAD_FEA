...
if (undef)
    line(x(ind1,:)',y(ind1,:)',z(ind1,:)','color','b','linestyle','-')
    line(x(ind2,:)',y(ind2,:)',z(ind2,:)','color','k','linestyle','-','linewidth',1) % ,'marker','o')
    line(x(ind3,:)',y(ind3,:)',z(ind3,:)','color','b','linestyle','-')
    line(x(ind4,:)',y(ind4,:)',z(ind4,:)','color','k','linestyle','-','linewidth',2)
end
...
if (def)
    if sum(U) ~=0
        ...
        line(x1(ind3,:)',y1(ind3,:)',z1(ind3,:)','color','k','linestyle','-','linewidth',1)
