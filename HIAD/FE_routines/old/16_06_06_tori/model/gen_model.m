function [FEM] = gen_model(theta,I_theta_cable,I_theta_support,tor)
% April 29, 2016
% Generate torus load testing model

% Load elements
% Torus elements
[FEM.MODEL,FEM.EL] = torus(theta,I_theta_cable,tor);

% % % % Link elements
% % % [MODEL_link,EL_link] = links(theta,I_theta_cable,tor);

% % % % Cable elements
% % % [MODEL_cable,EL_strap] = cables(theta,I_theta_cable);
