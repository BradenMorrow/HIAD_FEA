function [eps_cord,f_cord,k_cord,kappa] = find_NA(D,eps_cord_old,p,r,alpha,GLH,t,EI0,L,cords,el)
...
[eps_cord] = get_eps(eps_cord_old + eps_ax,r,phi_i,phi_j,alpha,kappa2);
% eps_cord(:,1) = eps_cord(:,1) - eps_ax;
