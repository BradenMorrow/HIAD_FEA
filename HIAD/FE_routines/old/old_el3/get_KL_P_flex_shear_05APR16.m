...
while iterate
    ...
    for i = 1:n
        ...
        for m = 1:size(alpha,1) % Fibers
            ...
            force = interp1(axial(:,2),axial(:,1),[e(m,i) e(m,i) + tol1]',interp_meth);
            sig(m,i) = force(1);
        ...
        r(:,i) = f(:,:,i)*Du(:,i); % rho in Neuenhofer and Filippou (1997)
        ...
        si = b(:,:,i)'*r(:,i);
        s = s + L/2*wi(i)*si; % r in Neuenhofer and Filippou (1997)
