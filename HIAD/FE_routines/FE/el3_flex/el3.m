function [Kel,fint_i,Fint_i,ROT,el_out] = el3(U_in,el_in,el_in0)
%ELEMENT_5
...
if el_in0.state_it
    ...
    [KL,P,el_out0] = get_KL_P_flex_shear_iter(el_in1);
else
    % Non-iterative form of the state determination process
    [KL,P,el_out0] = get_KL_P_flex_shear_noniter(el_in1);
%     [KL,P,el_out0] = get_KL_P_flex_shear_noniter_P_delta(el_in1);
%     [KL,P,el_out0] = get_KL_P_flex_shear_noniter_P_delta_deSouza(el_in1);
end
