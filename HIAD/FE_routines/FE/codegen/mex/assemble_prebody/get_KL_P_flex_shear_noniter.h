 ...
 *
 * get_KL_P_flex_shear_noniter.h
 *
 * Code generation for function 'get_KL_P_flex_shear_noniter'
 *
 */

#ifndef __GET_KL_P_FLEX_SHEAR_NONITER_H__
#define __GET_KL_P_FLEX_SHEAR_NONITER_H__
...
extern void get_KL_P_flex_shear_noniter(emlrtCTX aTLS, real_T el_in_p, real_T
  ...
  emxArray_real_T *el_in_flex_D, const emxArray_real_T *el_in_flex_Du, const
  real_T el_in_flex_Q[5], const real_T el_in_flex_f_data[], const int32_T
...
/* End of code generation (get_KL_P_flex_shear_noniter.h) */
